...
$(function(){
    var rightNav = "";
    rightNav += "<ul class='ccRightNav' data=‘1’ >";
    rightNav += "<li><a href='http://www.qijishow.com/' target='_blank'>奇迹秀</a></li>";
    rightNav += "<li><a href='http://www.qijishow.com/time.htm' target='_blank'>记录线</a></li>";
    rightNav += "<li><a href='http://www.qijishow.com/tibi/index.html' target='_blank'>唯提笔</a></li>";
    rightNav += "<li><a href='http://www.qijishow.com/down/index.html' target='_blank'>工具箱</a></li>";
	rightNav += "<li><a href='http://www.qijishow.com/down/resource.html' target='_blank'>资源库</a></li>";
    rightNav += "<hr>";
    rightNav += "<li class='qrBtn'><a href='http://www.qijishow.com/Brand/Brand5/index.htm' target='_blank'>微信公众号</a></li>";
    rightNav += "<li class='qrBox'><img src='http://www.qijishow.com/img/ewm01.jpg' alt='微信二维码'/></li>";
    rightNav += "</ul>";
...
function scrollPlus()
{
    ...
    function make_boxes()
    {
        if (!b)
        {
            ...
            b.setAttribute("style", "width:44px;background:url(http://www.qijishow.com/down/assets/images/snav_icon.png) 14px 10px no-repeat rgb(175, 175, 175);min-height:36px;text-align:center;border-top-left-radius: 100px;border-bottom-left-radius: 100px;position: fixed; top: -40px; right: 0;overflow: hidden; z-index: 102400;font-family:Arial !important;cursor:n-resize;cursor:ns-resize;");
